...
from trainer import trainer_kits23
from icecream import ic

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='./data/', help='root dir for data')
parser.add_argument('--output', type=str, default='./KiT23/output/')
parser.add_argument('--dataset', type=str,
                    default='KiTS23', help='experiment_name')
parser.add_argument('--list_dir', type=str,
                    default='./lists/lists_KiTS23/', help='list dir')
...
parser.add_argument('--batch_size', type=int,
                    default=26, help='batch_size per gpu')
...
parser.add_argument('--warmup_period', type=int, default=600,
...
if __name__ == "__main__":
    ...
    sam, img_embedding_size = sam_model_registry[args.vit_name](image_size=args.img_size,
                                                                num_classes=args.num_classes,
                                                                checkpoint=args.ckpt, pixel_mean=[16.9, 16.9, 16.9], #based on KiTS23_preproc_data
