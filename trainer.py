...
def trainer_kits23(args, model, snapshot_path, multimask_output, low_res):
    from datasets.dataset_kits23 import KiTS23_dataset, RandomGenerator
    ...
    db_train = KiTS23_dataset(base_dir=args.root_path, list_dir=args.list_dir, split="train",
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            assert image_batch.max() <= 255.0, f'image_batch max: {image_batch.max()}'
            if args.use_amp:
